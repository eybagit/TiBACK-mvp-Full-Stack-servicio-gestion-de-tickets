...
function ChatAnalistaCliente() {
    ...
    useEffect(() => {
        if (ticketId && store.websocket.socket && store.websocket.connected) {
            console.log('🔍 DEBUG: Uniéndose a global_tickets para ticket', ticketId);
            ...
            const handleNuevoMensaje = (data) => {
                console.log('💬 NUEVO MENSAJE EN GLOBAL_TICKETS:', data);
                ...
                if (data.tipo === 'chat_analista_cliente' && data.ticket_id === parseInt(ticketId)) {
                    ...
                    if (esParticipante) {
                        console.log('✅ Usuario es participante, recargando mensajes');
                        setSincronizando(true);
                        cargarMensajes(false).finally(() => setSincronizando(false));
                    } else {
                        console.log('⚠️ Usuario NO es participante, ignorando mensaje');
                    }
                }
            };
            ...
            console.log('🔍 DEBUG: Listener agregado para nuevo_mensaje_chat desde global_tickets');
                ...
                <div className="p-4">
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-8 col-lg-6 col-xl-4">
                                <div className="card">
                                    <div className="card-header p-3 chat-header-primary">
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="d-flex align-items-center">
                                                <div className="rounded-circle d-flex align-items-center justify-content-center text-white bg-success me-2 chat-participant-icon">
                                                    <i className="fas fa-user icon-tiny"></i>
                                                </div>
                                                ...
                                                <div key={mensaje.id || index} className={`d-flex ${isCurrentUser(mensaje.autor?.rol) ? 'justify-content-end' : 'justify-content-start'} mb-3`}>
                                                    <div className={`d-flex align-items-end chat-message-container ${isCurrentUser(mensaje.autor?.rol) ? 'flex-row-reverse' : 'flex-row'}`}>
                                                        ...
                                                        <div className={`d-flex flex-column ${isCurrentUser(mensaje.autor?.rol) ? 'align-items-end' : 'align-items-start'}`}>
                                                            <div className={`p-3 chat-message-bubble ${isCurrentUser(mensaje.autor?.rol) ? 'bg-primary text-white chat-message-bubble-sent' : 'bg-light text-dark chat-message-bubble-received'}`}>
